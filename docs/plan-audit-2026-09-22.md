...
| Kajak-Galerie | 12 freigegebene Bilder, dokumentierte Herkunft und anonymisierte Kennzeichen; die zwei Bilder mit Kindern sind ausschließlich von hinten gezeigt | Am 22. September nach Webdienst-Rollout auf `https://vanventure.at/kajak.html` live geprüft; Design Guide V1 ist freigegeben. |
