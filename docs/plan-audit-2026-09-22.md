...
| Kajak-Hero und -Galerie | Gespiegeltes Fjordbild mit Boot rechts, Verlauf und freigegebener Hero-Einleitung; 14 veröffentlichte Galeriebilder mit dokumentierter Herkunft und anonymisierten Kennzeichen. Die drei Bilder mit Kind sind ausdrücklich für die Galerie freigegeben. | Nach einer beim Hero-Umbau entdeckten Entfernung gemeinsam wiederhergestellt und am 22. September erneut live auf `https://vanventure.at/kajak.html` einschließlich Vollansicht geprüft. Die automatisierte Inhaltsprüfung sichert alle sieben öffentlichen Seiten mit ihren Kernmodulen, Galerien, Kachelzahlen, Bilddateien, Canonical- und internen Seitenlinks; beim Kajak zusätzlich alle verbindlichen Hero-Merkmale und die lückenlose Bildfolge 01–14. |
| Galerie-Default | Jede öffentliche Inhalts-Unterseite erhält eine Galerie; Ausnahmen müssen für die jeweilige Seite ausdrücklich entschieden und im Gesamtplan festgehalten sein | Mit der Freigabe von Design Guide V1 am 22. September verbindlich und auf Kajak, Fahrzeug, Ausrüstungsübersicht, Radübersicht sowie Reisegalerien live umgesetzt. Die fünf ausdrücklich benannten Radprofile bleiben die einzige vorläufige Ausnahme. |
...
| Englische redaktionelle Inhalte | Kajak/Riverstar, Ausrüstung und Räder nutzen eine geprüfte, rückschaltbare Übersetzungslogik für ihre Fließtexte, Karten und Überschriften | Am 22. September nach Webdienst-Neustart auf `https://vanventure.at/kajak.html`, `ausruestung.html` und `bike.html` live mit EN und Rückwechsel auf DE geprüft. |
